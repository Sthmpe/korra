    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<OutrightOrdersBloc>(
          create: (_) => OutrightOrdersBloc(
            repo: vendors,
            vendorId: widget.vendorId,
            initial: OutrightOrderStatus.pending,
          )..add(OutrightOrdersStarted(OutrightOrderStatus.pending)),
        ),
      ],
      child: BlocBuilder<ReservationsBloc, ReservationsState>(
        builder: (context, resState) {
          ...
          return Scaffold(
            ...
            floatingActionButton: _currentIndex == 0 && resState.selectedIds.isNotEmpty
