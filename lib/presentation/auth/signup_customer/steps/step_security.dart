...
class _StepSecurityState extends State<StepSecurity> {
  ...
  void initState() {
    ...
    _passCtl = TextEditingController(text: s.password)
      ..addListener(() => _on(PasswordChangedCU(_passCtl.text)));
    _confCtl = TextEditingController(text: s.confirm)
      ..addListener(() => _on(ConfirmPasswordChangedCU(_confCtl.text)));
  }
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<SignupCustomerBloc, SignupCustomerState>(
              buildWhen: (p, c) =>
                  p.hidePassword != c.hidePassword || p.password != c.password,
              builder: (_, s) {
                return _PremiumInput(
                  ...
                  onTogglePass: () => _on(TogglePasswordVisibilityCU()),
            ...
            BlocBuilder<SignupCustomerBloc, SignupCustomerState>(
              ...
              builder: (_, s) {
                return _PremiumInput(
                  ...
                  onTogglePass: () => _on(ToggleConfirmVisibilityCU()),
