...
class _StepPersonalState extends State<StepPersonal> {
  ...
  void initState() {
    ...
    _firstCtl = TextEditingController(text: s.firstName)..addListener(() => _on(FirstNameChanged(_firstCtl.text)));
    _lastCtl  = TextEditingController(text: s.lastName)..addListener(() => _on(LastNameChanged(_lastCtl.text)));
    _otherCtl = TextEditingController(text: s.otherName)..addListener(() => _on(OtherNameChanged(_otherCtl.text)));
    _phoneCtl = TextEditingController(text: s.phone)..addListener(() => _on(PhoneChanged(_phoneCtl.text)));
    _emailCtl = TextEditingController(text: s.email)..addListener(() => _on(EmailChangedCU(_emailCtl.text)));
  }
